...
contract SimpleBank {
    ...
    function enroll() public returns (bool){
      require(enrolled[msg.sender] == false, "User is already enrolled.");
    ...
    //to avoid overflow vulnerability
    ...
    function deposit() public payable returns (uint) {
        ...
        require(enrolled[msg.sender] == true, "User is not enrolled yet.");
        require(msg.value > 0, "Sent value <= 0");

        //there is probably a security problem here
    ...
    function withdraw(uint withdrawAmount) public payable returns (uint) {
        ...
        balances[msg.sender] = sub(balances[msg.sender], withdrawAmount); 
